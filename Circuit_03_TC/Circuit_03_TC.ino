...
void loop()
{
  ...
  // TC: modified mainColors to accept int, which determines time
  // between color changes. Also added a potentiometer to control
  // that value.
  
  int sensorValue;
  sensorValue = analogRead(SENSOR_PIN);
  
  mainColors(sensorValue);
